...
def save_recording(job, state, detail=''):
    ...
    data = {key: job[key] for key in ('job_id', 'source', 'source_name', 'note', 'origin', 'storage', 'quality', 'output_format', 'is_live', 'requested_at', 'started_at', 'elapsed', 'size', 'filename', 'stop_reason') if key in job}
